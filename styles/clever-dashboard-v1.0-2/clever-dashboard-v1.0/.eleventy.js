...
function eleventyConfig(config) {
	...
	config.addLayoutAlias("alt", "layouts/alt.njk");
	config.addLayoutAlias("columns", "layouts/columns.njk");
	config.addLayoutAlias("screen", "layouts/screen.njk");
	config.addLayoutAlias("auth", "layouts/auth.njk");
	config.addLayoutAlias("chat", "layouts/chat.njk");
